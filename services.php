...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="assets/images/logoNfecsa.png"
      type="image/x-icon"
    />
  </head>
  ...
  <body>
    ...
    <header class="position-absolute w-100">
      <div class="container">
        ...
        >
          <div class="contact">
            <a href="tel:07062458130" class="tel"
              ><i class="fa fa-phone" aria-hidden="true"></i>07062458130</a
            >
            <a href="mailto:info@yourmail.com"
              ><i class="fa fa-envelope" aria-hidden="true"></i
              >enquiries@nafecsalumni.org
            </a>
          </div>
        ...
        <nav class="navbar navbar-expand-md navbar-light">
          <a class="navbar-brand" href="index.html"
            ><img src="assets/images/logoNfecsa.png" alt="Multipurpose"
          /></a>
