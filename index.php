...
<body>
  ...
  <header class="position-absolute w-100">
    <div class="container">
      ...
      <div class="
          ...
          ">
        <div class="contact">
          <a href="tel:07062458130" class="tel"><i class="fa fa-phone" aria-hidden="true"></i>07062458130</a>
          <a href="mailto:info@yourmail.com"><i class="fa fa-envelope" aria-hidden="true"></i>enquiries@nafecsalumni.org
          </a>
        </div>
      ...
      <nav class="navbar navbar-expand-md navbar-light">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="monthly-webinar.php">Monthly Webiner</a>
            </li>
            <!-- <li class="nav-item">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide slide-content d-flex align-items-center">
                <div class="single-slide">
                  <h2 data-aos="fade-right" data-aos-delay="200" style="margin-top: 30px">
                    National Fellowship of Economics<br />
    ...
    <div class="container">
      <div class="
        ...
        <div class="content" data-aos="fade-right" data-aos-delay="200">
          <h2 style="margin-left: 14px">WE ARE NAFECS Alumni-UCC</h2>
          <p style="margin-left: 40px">
            NAFECS Alumni-UCC is a movement to build a strong network who will
            enlighten the public on topical economic issues through our
            <b>Public Enlightenment Monthly Webinar Series..</b>
          </p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
          ...
          <p>
            ...
            in places all over the world who will be part of a team that
            provides career development, and mentoring services.
          </p>
          <p>
            We also exist to enlighten the public on topical economic issues.
            This will achieve this through our “Public Enlightenment Monthly
            Webinar Series” and Outreaches.
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="col-sm-12 col-lg-12">
            <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
              ...
              <div class="media-body">
                <h5>NAFECS Services</h5>
                Our members are involved in various commercial activities.
                Kindly find below the available services and contact numbers
              </div>
            </div>
  ...
  <!-- Background image  -->
  <section class="services" style="background-color: antiquewhite;">
    <div class="container">
      <div class="col-sm-12 col-lg-12">
        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
          <img src="assets/images/webinar-1.jpg" alt="" style="
        width: 100%;
        max-width: 100%;
        background-color: rgba(255, 36, 0, 0.07);
        opacity: 0.7;
        object-fit: cover;
        ">
        </div>
  ...
  <!-- Monthly Webinars Start -->
  <section class="featured">
    <div class="container">
      <div class="row">
        <div class="col-md-12" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
          <div class="title">
            <h2 class="title-primary">Monthly Webinars</h2>
            <h4 class="title-blue">NOVEMBER 2021</h4>
          </div>
          <p>
          In a quest to encourage research at the undergraduate level and enlighten the public on topical economic issues, a monthly writing contest is conducted for the undergraduate students. The undergraduate student with the best research work wins a cash donation and gets to present this research findings at a webinar.
          </p>
          <div class="media-element d-flex justify-content-between" style="margin-top: -100px">
            <a href="monthly-webinar.php" class="btn btn-primary">See More</a>
          </div>
          <!-- <div class="media-element d-flex justify-content-between">
                        <div class="media">
                            <i class="fa fa-magic mr-4"></i>
          ...
          <!-- <div class="col-md-6" data-aos="fade-left" data-aos-delay="400" data-aos-duration="800">
                    <div class="featured-img">
                        <img class="featured-big" src="assets/images/webinar001.jpg" alt="Featured 1">
    ...
    <div class="container">
      <div class="
        ...
        <div class="content" data-aos="fade-right" data-aos-delay="200">
          <h2>Contact</h2>
          <p>
            For sponsorship of our activities and/or general enquiries call:
            07062458130 or send an email to enquiries@nafecsalumni.org
          </p>
        </div>
        <br />
        <!-- <div class="subscribe-btn" data-aos="fade-left" data-aos-delay="400" data-aos-offset="0">
        ...
        <div class="row">
            ...
            <div class="single-widget contact-widget" data-aos="fade-up" data-aos-delay="0">
              ...
              <div class="media">
                ...
                <div class="media-body ml-3">
                  ...
                  <br />
                  Univerity Of Calabar Cross River State Nigeria
                </div>
              </div>
              <div class="media">
                ...
                <div class="media-body ml-3">
                  ...
                  <a href="mailto:inahngwu.ebock@nafecsalumni.org">enquires@nafecsalumni.org</a>
                </div>
              </div>
              <div class="media">
                ...
                <div class="media-body ml-3">
                  <h6>Call us</h6>
                  <a href="tel:07062458130"> 07062458130</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-xl-3">
            <div class="single-widget twitter-widget" data-aos="fade-up" data-aos-delay="200">
              <h6 class="widget-tiltle">Quick Links</h6>
              <div class="media">
    ...
    <div class="foot-note">
      <div class="container">
        <div class="
              ...
              align-items-center
            ">
          <p style="color: white" class="mb-0" data-aos="fade-right" data-aos-offset="0">
            &copy; 2021 All Rights Reserved.
            <!-- <a href="https://freehtml5.co/multipurpose" target="_blank" class="fh5-link">FreeHTML5.co</a>. -->
          </p>
          <p class="mb-0" data-aos="fade-left" data-aos-offset="0">
            <a href="#" style="color: white">Terms Of Use</a><a href="#" style="color: white">Privacy & Security Statement</a>
          </p>
        </div>
      </div>
    </div>
