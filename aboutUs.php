    ...
    <div class="container">
      ...
      <a  class="navbar-brand" href="index.php"><img style="width: 100px;" src="assets/images/NAFECS ALUMNI LOGO.png" alt="Multipurpose" /></a>
        <div class="group d-flex align-items-center">
          ...
          <!-- q<a class="login-icon d-sm-none" href="#"><i class="fa fa-user"></i></a> -->
      ...
      <div class="row">
        <div class="col-md-12" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
          <div class="title">
            ...
            <h4 class="title-blue">VISION STATEMENT</h4>
          </div>
          <p>
            Raising leaders who will be effective discipler of the rising generation.
          </p>
        </div>
        <div class="col-md-12" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
          <div class="title">
            <!-- <h2 class="title-primary">Monthly Webinars</h2> -->
            <h4 class="title-blue">MOTOR</h4>
          </div>
          <p>
            Leadership with the right mindset
          </p>
        </div>
        <div class="col-md-12" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
          <div class="title">
            <!-- <h2 class="title-primary">Monthly Webinars</h2> -->
            <h4 class="title-blue"> MISSION STATEMENT</h4>
          </div>
          <p>
            Building a circle of intellectual like minded leaders, who set pace for others to follow - through community service, students' grant offers, writing challenge, fellowship and giving a helping hand.
          </p>
        </div>
