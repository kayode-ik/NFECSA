...
border-bottom: 1px solid gray;" type="text" id="name" name="name" class="form-control">
                      ...
                      <div class="col-md-6">
                        <div class="md-form mb-0">
                          <input style="color: black !important;
border-bottom: 1px solid gray;" type="text" id="email" name="email" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="md-form mb-0">
                          <input style="color: black !important;
border-bottom: 1px solid gray;" type="text" id="subject" name="subject" class="form-control">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="md-form">
                          <textarea style="border: 1px solid gray;color:black !important" type="text" id="message" name="message" rows="2" class="form-control md-textarea"></textarea>
